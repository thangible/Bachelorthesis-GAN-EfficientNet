...
class Generator(nn.Module):
    def __init__(self, channels_noise, channels_img, features_g, class_num):
        ...
        self.net = nn.Sequential(
            ...
            self._block(channels_noise + self.class_num, features_g * 64, 4, 1, 0),
            self._block(features_g * 64, features_g * 32, 4, 2, 1),
